/* Desert Fog Mycology — public-facing translations (en-US, es-MX, fr-CA, pt-BR).
   Brand terms (Desert Fog Mycology, grush) are left untranslated. */
window.I18N = {
  langs: ['en','es','fr','pt'],
  dict: {
    en: {
      ...
      'hub.intro':'Welcome. Explore the farm, see what we grow, and plan your own.',
      'tile.see':'See','tile.see_sub':'Photos from the farm',
      'tile.learn':'Learn','tile.learn_sub':'About the mushrooms',
      'tile.do':'Do','tile.do_sub':'Plan your grow',
      'tile.share':'Share','tile.share_sub':'Leave a note',
      'about.title':'About Desert Fog Mycology',
      'about.body':'Desert Fog Mycology is a container mushroom farm in Riverside, California — a single 40-foot shipping container designed to grow gourmet and functional mushrooms year-round, from substrate and inoculation through fruiting and harvest, run by one operator. Heat-loving species in summer, cool-fruiting species in winter.',
      'menu.title':'Menu','back':'Back','back.allplants':'All mushrooms',
      'see.intro':'Photos from around the farm.',
      'learn.intro':'Every mushroom we grow — what it is, and how it fruits.',
      'do.intro':'Pick a mushroom and get a grow plan — the numbers worked out for your setup.',
      'share.intro':'Leave a note for the farm. Comments appear after a quick review.',
      'share.recent':'Recent notes',
      'ph.search':'Search mushrooms…','ph.name':'Your name (optional)','ph.msg':'Your message…',
      'loading.photos':'Loading photos…','loading.plants':'Loading mushrooms…',
      'ag.kicker':'a management platform for growing spaces','ag.lead':'grush turns the daily work of running a growing space — a garden, a farm, a controlled-environment grow — into something simple enough to use with dirt on your hands.','ag.body':'Tasks, plantings, harvests, inventory, and records become a tap-not-type system anyone on the ground can run. Over time, that daily work turns into real data: what was planted, when, where, and how it did.','ag.deployments':'Deployments','ag.deploy_desc':'Every place that runs grush is a deployment — branded as its own, running on the same engine underneath.','ag.deploy_card':'Desert Fog Mycology is a deployment of grush — a container mushroom farm in Riverside, California.','ag.back':'Back to Desert Fog Mycology'
    },
    es: {
    ...
    fr: {
      ...
      'hub.intro':'Bienvenue. Parcourez la ferme, découvrez ce que nous cultivons et planifiez votre propre culture.',
      'tile.see':'Voir','tile.see_sub':'Photos de la ferme',
      'tile.learn':'Apprendre','tile.learn_sub':'À propos des champignons',
      'tile.do':'Faire','tile.do_sub':'Planifiez votre culture',
      'tile.share':'Partager','tile.share_sub':'Laissez un mot',
      'about.title':'À propos de Desert Fog Mycology',
      'about.body':'Desert Fog Mycology est une ferme de champignons en conteneur à Riverside, en Californie : un seul conteneur maritime de 40 pieds conçu pour cultiver des champignons gastronomiques et fonctionnels toute l’année, du substrat et de l’inoculation jusqu’à la fructification et la récolte, exploité par une seule personne. Espèces aimant la chaleur en été, espèces à fructification au frais en hiver.',
      'menu.title':'Menu','back':'Retour','back.allplants':'Tous les champignons',
      'see.intro':'Photos des quatre coins de la ferme.',
      'learn.intro':'Chaque champignon que nous cultivons : ce qu’il est et comment il fructifie.',
      'do.intro':'Choisissez un champignon et obtenez un plan de culture, avec les chiffres calculés pour votre installation.',
